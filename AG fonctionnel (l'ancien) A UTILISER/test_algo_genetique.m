...
function [liste_taub_max,liste_individus_taub_max,liste_taub_moyen,liste_taub_complete,liste_individus_complete,iteration]=test_algo_genetique(nbre_profils_par_individu,NBRE_GENERATIONS)
